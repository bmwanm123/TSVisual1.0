...
export default {
  ...
  methods: {
    initLineChart() {
      ...
      d3Queue
        .queue()
        // .defer(d3.json, '@/assets/SentenceData/GRCh37.json')
        // .defer(d3.csv, '@/assets/SentenceData/cytobands.csv')
        // .defer(d3.csv, '@/assets/SentenceData/snp.density.250kb.txt')
        // .defer(d3.csv, '@/assets/SentenceData/snp.density.txt')
        // .defer(d3.csv, '@/assets/SentenceData/snp.density.1mb.txt')
        .await(this.dMain)
    },
    drawCircos(GRCh37, cytobands, snp250, snp, snp1m) {
      console.log(GRCh37)
    ...
    dMain() {
      ...
      this.buildCircos('#chart1', snp250, [
        {
          color: 'red',
          position: 0.002
        },
      ...
      this.buildCircos('#chart2', snp250, [
        {
          color: '#333333',
          spacing: 0.001,
          opacity: 0.3
      ...
      this.buildCircos('#chart3', snp250, [
        {
          color: 'red',
          opacity: 0.3,
          spacing: 0.001,
    ...
    buildCircos(container, snp250, axes) {
      ...
      circos
        .layout([{ id: 'chr2', color: '#03a9f4', len: 243199373 }], {
          innerRadius: 400,
          outerRadius: 400,
          labels: { display: false },
          ticks: { display: false }
